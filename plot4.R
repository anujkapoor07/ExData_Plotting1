...
par(mfrow = c(2,2))
with(converted_data, {
  plot(converted_data$date_time, converted_data$Global_active_power, type="l", xlab = "", ylab = "Global Active Power")
  plot(converted_data$date_time, converted_data$Voltage, type="l", xlab = "datetime", ylab = "Voltage")
  ...
  plot(converted_data$date_time, converted_data$Global_reactive_power, type="l", xlab = "datetime", ylab = "Global_reactive_power")
}
)
dev.off()